...
quasi-ballistic Piledriver that carries three maneuverable warheads (MW-220)
...
*this mod an **unofficial** mod for Nuclear Option® (by Shockfront Studios on [steam](https://store.steampowered.com/app/2168680/Nuclear_Option/))and it is **not affiliated with or endorsed** by Shockfront Studios.
The textures and Mesh for the Piledriver QBM,HLT truck,MSV missile launcher, and textures for MW-220 are dirctly pulled form original game, so those asset are copyrighted by © 2026 Shockfront Studios:
